...
#### DEFAULT PARAMETERS IS ASSIGNED ONLY IF ARGUMENT IS UNDEFINED, YOU CAN ASSIGN FUNCTION INVOCATIONS TO DEFAULT PARAMETERSS
```jsx
    ...
    greet();
```
#### DEFAULT PARAMETERSS ARE AVAILABLE TO LATER DEFAULT PARAMETERSS
```jsx
...
#### Deconstruction assignment is also possible to use while assigning DEFAULT PARAMETERSs
```jsx
